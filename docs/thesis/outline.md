...
| 4 | Design: bounded contexts and layers; the regime-parameterised state machine; regulatory clocks; the ledger; state row plus append-only log; spec-first contract and error taxonomy (server and client); multi-tenancy with row-level security; two credential kinds | 9 | ADR 0001, 0002, 0004, 0006, 0008, 0009, 0010, 0011, 0012, 0013, 0014 |
