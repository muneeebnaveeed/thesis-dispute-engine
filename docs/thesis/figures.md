...
| 6.2 | 6 | Transition coverage per regime | `make thesis:eval` correctness table | todo (after first run) |
| 6.3 | 6 | Latency percentiles per route under load | `make thesis:eval` latency table | todo |
