...
% To write: ADR 0006 and 0012. Stub so the implementation chapter's references resolve.

\section{Multi-tenancy with row-level security}
\label{sec:design-tenancy}
% To write: ADR 0008 and 0009. Stub so the communications and workbench sections resolve.
