...
communications panel; tenant admins reword them on the Templates page (`/<slug>/templates`), which stores an
override per tenant and never changes the form. Recipients come
